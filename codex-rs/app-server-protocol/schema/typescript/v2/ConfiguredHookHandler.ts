...
export type ConfiguredHookHandler = { "type": "command", command: string, commandWindows: string | null, timeoutSec: bigint | null, async: boolean, interactive: boolean, statusMessage: string | null,
/**
